...
full_dis = 'https://github.com/KirillVG/streamlit/blob/main/15022022_11.20.xlsx'

@st.cache
def load_excel(data_link, sheet, col_name):
    dataset = pd.read_excel(data_link, sheet, index_col=False, usecols=col_name, engine='openpyxl')
    return dataset
